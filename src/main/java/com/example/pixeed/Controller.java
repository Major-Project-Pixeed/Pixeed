...
public class Controller implements Initializable {
    ...
    @FXML
    public void faceRecog(ActionEvent actionEvent) {
        System.out.println("1111 done");
        Imgcodecs imgcodecs = new Imgcodecs();
        System.loadLibrary(Core.NATIVE_LIBRARY_NAME);
        FaceRecognition faceRecognition = new FaceRecognition();
        faceRecognition.faceRecognise(file, imgcodecs, activeImageView);
    }
    ...
    void SETFRAME1(ActionEvent event) throws FileNotFoundException {
        com.example.softablitz.ImageFrame.SETFRAME1(imageViewPane);
        stk.push(imageViewPane.getChildren());
    }

    @FXML
    void SETFRAME2(ActionEvent event) throws FileNotFoundException {
        com.example.softablitz.ImageFrame.SETFRAME2(imageViewPane);
        stk.push(imageViewPane.getChildren());
    }
    ...
    void SETFRAME3(ActionEvent event) throws FileNotFoundException {
        com.example.softablitz.ImageFrame.SETFRAME3(imageViewPane);
    }


    @FXML
    void SETFRAME4(ActionEvent event) throws FileNotFoundException {
        com.example.softablitz.ImageFrame.SETFRAME4(imageViewPane);
    }


    @FXML
    void SETFRAME5(ActionEvent event) throws FileNotFoundException {
        com.example.softablitz.ImageFrame.SETFRAME5(imageViewPane);
        stk.push(imageViewPane.getChildren());
    }
    ...
    void SETFRAME6(ActionEvent event) throws FileNotFoundException {
        ...
        com.example.softablitz.ImageFrame.SETFRAME6(imageViewPane);
        stk.push(imageViewPane.getChildren());
    }
